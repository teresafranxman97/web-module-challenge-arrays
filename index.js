...
function removeLastFlavor(outWithTheOld){
...
function getFlavorByIndex(someFlavor){
...
function removeFlavorByName(inWithTheNew){
    removeFlavorByName(originalFlavors, "Vanilla");
}

originalFlavors.splice([30]);
console.log(originalFlavors);
...
let newNewArray= [...originalFlavors];
function copy(theOGarray, newArray){
...
/* function filterByWord(chocoWord){
